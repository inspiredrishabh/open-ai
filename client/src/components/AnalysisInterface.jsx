    ...
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900 text-neutral-900 dark:text-white">
      <div className="flex flex-col">
        ...
        <div className="h-[65vh] p-6 bg-neutral-50 dark:bg-neutral-900">
          ...
          {/* Coordinates panel overlay on map */}
          <div className="absolute bottom-4 left-4 right-4 bg-white/95 dark:bg-neutral-800/95 backdrop-blur-sm border border-neutral-200 dark:border-neutral-700 rounded-lg p-4 shadow-lg">
        ...
        {/* Analysis parameters section - horizontal below map */}
        <div className="min-h-[35vh] bg-white dark:bg-neutral-800 border-t border-neutral-200 dark:border-neutral-700 p-6 overflow-y-auto">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {/* Parameters form - spans 2 columns */}
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <div className="text-sm font-medium text-neutral-900 dark:text-white mt-1">
                            {result?.usedImage ? "🛰️ NASA" : "📁 Upload"}
                          </div>
                        </div>
                      </div>
